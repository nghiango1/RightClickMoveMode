...
namespace RightClickMoveMode {
  public class ModConfig {
    ...
    public KeybindList HorseForceMoveToggleButton { get; set; } = KeybindList.Parse("LeftShift");
      ...
      if (config.RightClickMoveModeDefault) {
        ...
        if (flag) {
          ...
          if (flag2) {
            ...
            if (config.HorseForceMoveToggleButton.IsDown()&&Game1.player.isRidingHorse()) {
              Helper.Input.Suppress(e.Button);
            } else if (flag3) {
              Helper.Input.Suppress(e.Button);
